...
file_name = "F:/Assignment1/testcases/input/testcase1/input.txt";
test <- read.table(file_name,header = FALSE,sep = ",")
mat <- as.matrix(test)
file_name1 = "F:/Assignment1/testcases/output/testcase1/out_1.txt";
test1 <- read.table(file_name,header = FALSE,sep = ",")
mat1 <- as.matrix(test)
file_name2 = "F:/Assignment1/testcases/output/testcase1/out_2.txt";
test1 <- read.table(file_name,header = FALSE,sep = ",")
mat2 <- as.matrix(test)
file_name3 = "F:/Assignment1/testcases/output/testcase1/out_3.txt";
